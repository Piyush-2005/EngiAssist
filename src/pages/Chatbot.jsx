    ...
    // <PatientDashboardLayout>
      <div className="container mx-auto px-4 py-8 text-white">
          ...
          <div className=" overflow-y-auto h-[50vh] mb-4">
            ...
            {chatHistory.length === 0 ? (
              ...
              chatHistory.map((message, index) => (
                <div key={index} className={`message ${message.type === "user" ? "bg-blue-100 text-right" : "bg-green-100 text-left"} p-2 text-black rounded-lg mb-2`}>
                  {message.message}
                </div>
              ))
            )}
        ...
        <div className="flex mt-4">
          <input
            type="text"
            className="flex-grow px-4 py-2 text-white rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <button
          className="mt-4 block px-4 py-2 rounded-lg bg-gray-400 text-black hover:bg-gray-500 focus:outline-none"
          onClick={clearChat}
        >
          Clear Chat
        </button>
